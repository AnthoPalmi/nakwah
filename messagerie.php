                        ...
                        <div class="row placeholders">
                            <div class="col-xs-6 col-sm-3 placeholder">
                                ...
                                <span class="text-muted">
                                    <?php 
                                    if (isset($_POST['message_trajet']) && !empty($_POST['message_trajet'])) {
                                        form_select_multiple("Choix du membre", "membre", listMembres($login),$_POST['message_trajet']); 
                                    }else{
                                        form_select_multiple("Choix du membre", "membre", listMembres($login)); 
                                    }
                                    ?></span>
                            </div>
                            <div class="col-xs-6 col-sm-3 placeholder">
